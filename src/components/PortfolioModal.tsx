...
import { X, ExternalLink, CheckCircle2, Shield } from 'lucide-react';
...
export const PortfolioModal: React.FC<PortfolioModalProps> = ({
  ...
  const longDesc = project.longDescription || project.fullDescription || project.shortDescription || project.description || '';
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative z-10 w-full max-w-3xl rounded-2xl glass-card-elevated border border-cyan-500/40 shadow-[0_0_50px_rgba(0,242,254,0.2)] overflow-hidden my-8 max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-200"
      >
        ...
        <div className="relative h-56 sm:h-72 w-full overflow-hidden shrink-0">
          ...
          <button
            onClick={onClose}
            id="close-modal-btn"
            className="absolute top-4 right-4 p-2 rounded-full bg-black/60 border border-cyan-500/40 text-slate-200 hover:text-cyan-300 hover:bg-cyan-950 transition-colors z-20 cursor-pointer"
        ...
        <div className="p-4 sm:p-6 border-t border-cyan-500/20 bg-[#060e22] flex flex-wrap items-center justify-between gap-4 shrink-0">
          ...
          <div className="flex items-center gap-3">
            <button
              onClick={onClose}
              className="px-4 py-2 rounded-lg text-xs font-mono text-slate-300 border border-slate-700 hover:bg-slate-800 transition-colors cursor-pointer"
            >
              Close
            </button>
            ...
            <button
              ...
              className="px-5 py-2 rounded-lg bg-gradient-to-r from-cyan-400 to-blue-500 text-black font-mono font-bold text-xs tracking-wider shadow-[0_0_20px_rgba(0,242,254,0.3)] hover:shadow-[0_0_30px_rgba(0,242,254,0.6)] flex items-center gap-1.5 transition-all cursor-pointer"
            >
